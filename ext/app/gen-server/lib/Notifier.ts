...
export class UnsubscribeNotifier implements INotifier {
  ...
  public async addBillingManager(hostUserId: number, addUserId: number, orgs: Organization[]): Promise<void> {}
  public async firstLogin(user: FullUser): Promise<void> {}
  public async teamCreator(userId: number): Promise<void> {}
  public async userChange(change: UserChange): Promise<void> {}
  public async trialPeriodEndingSoon(
    account: BillingAccount,
    subscription: { trial_end: number | null }): Promise<void> {}
  public async trialingSubscription(account: BillingAccount): Promise<void> {}
  public async scheduledCall(userRef: string): Promise<void> {}
  public async streamingDestinationsChange(orgId: number | null): Promise<void> {}
  public async twoFactorStatusChanged(event: TwoFactorEvent, userId: number, method?: 'TOTP' | 'SMS'): Promise<void> {}
